...
$APT_MGR install xfce4-session || exit $?

showMessage 'Aptitude : Installing Desktop minimal'
$APT_MGR install cairo-dock hpijs hplip-gui hp-ppd gimp openoffice.org-writer openoffice.org-calc openoffice.org-impress openoffice.org-draw iceweasel-l10n-fr totem-mozilla deluge meld totem-plugins rhythmbox-plugins rhythmbox-plugin-cdrecorder inkscape virtualbox-ose filezilla vlc fslint gcalctool || exit $?

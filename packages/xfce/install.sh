...
$APT_MGR install hpijs hplip-gui hp-ppd cairo-dock cairo-dock-plug-ins gimp openoffice.org-writer openoffice.org-calc openoffice.org-impress openoffice.org-draw meld totem-plugins rhythmbox-plugins rhythmbox-plugin-cdrecorder filezilla vlc fslint gcalctool gnome-terminal gedit file-roller evince || exit $?
